Esta é pasta do jogo **"Lava-Rápido de gente"**, feito em Scratch como ferramenta pedagógica para minha atividade extensionista.

Aqui há as imagens usadas no jogo (geradas com ChatGPT) e arquivos `.SB3` de três versões do jogo, sendo:
